    ...
    <div className="min-h-screen bg-primary">
      <section className="h-screen relative">
        <div className="absolute inset-0 z-0">
          {userLocation && (
            <MapContainer
              center={[userLocation[0], userLocation[1] - 0.008]}
              zoom={15}
        ...
        <div className="absolute top-0 left-0 h-full w-96 bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-md shadow-2xl p-8 z-10 border-r border-gray-200/50">
          <div className="animate-fade-in">
            ...
            <p className="text-gray-700 mb-8 text-lg leading-relaxed">
              Book an appointment in seconds with trusted veterinarians near
              you.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Mark your location on the map or enter an address to find nearby
                clinics
              </p>
            </div>
            ...
            <div className="group text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Discover available veterinarians near you with real-time
                availability
              </p>
            </div>
            ...
            <div className="group text-center bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">
                Create your appointment with a single click and get instant
                confirmation
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-center text-gray-600 mb-16 text-lg">
            Trusted by thousands of pet owners and veterinarians
          </p>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-secondary/20 to-primary/20 rounded-full mr-4 flex items-center justify-center text-2xl">
                    🐾
                  </div>
                  <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  "Great platform! I was able to quickly book an appointment in
                  emergencies. The interface is intuitive and the service is
                  reliable."
                </p>
