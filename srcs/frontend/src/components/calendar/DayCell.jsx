  ...
  return (
    <button
      ...
      className={`
        ...
        ${!isCurrentMonth ? 'bg-gray-50 text-gray-300 cursor-not-allowed' : 'bg-white hover:bg-gray-50 cursor-pointer'}
    ...
    >
      ...
      <div className="flex justify-between items-start mb-2">
        <span className={`text-sm font-semibold ${
          isToday ? 'bg-secondary text-white px-2 py-1 rounded-full' : 
